...

{
    ...
    type DiscrimeBy<O extends object, key extends keyof Overlap<O>, R extends object = never, U extends O = FirstOrLast_<O>> = Exclude<O, U> extends never
        ? key extends keyof U ? R | U : R
        //@ts-expect-error
        : DiscrimeBy<Exclude<O, U>, key, key extends keyof U ? R | U : R>
    ...
    type UU = { a: 1 } | { a: 2, b: 2 } | { b: 11, d: 7 }
    type D = DiscrimeBy<UU, 'b'>
    let d: D = {
        a: 2,
        b: 2
    }
